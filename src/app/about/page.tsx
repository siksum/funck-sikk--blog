...
export default function AboutPage() {
  ...
  const SectionHeader = ({
    ...
    >
      <span className="w-10 h-10 rounded-lg bg-violet-100 dark:bg-transparent flex items-center justify-center text-violet-600 dark:text-violet-200 border border-transparent dark:border-violet-400">
        {icon}
      </span>
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div className="text-center md:text-left flex-1" variants={fadeInUp}>
              ...
              <p className="text-xl text-violet-600 dark:text-violet-200 font-medium mb-2">Security Researcher</p>
            ...
            {[
              ...
              <button
                ...
                className={`flex-1 px-4 py-2.5 rounded-lg font-medium text-sm transition-all duration-200 flex items-center justify-center gap-2 ${
                  activeTab === tab.id
                    ? 'about-tab-active text-violet-600 dark:text-violet-200 shadow-sm dark:shadow-none border-transparent dark:border dark:border-violet-400'
                  ...
                  return filteredItems.map((item, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="text-violet-600 dark:text-violet-200 font-medium text-sm">{item.subtitle}</p>
                  ...
                  return journals.map((pub, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="text-sm text-violet-600 dark:text-violet-200 mb-1">{pub.authors}</p>
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm text-violet-600 dark:text-violet-200 font-mono">{patent.code}</span>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                >
                  ...
                  <p className="text-violet-600 dark:text-violet-200 text-sm">{activity.org}</p>
                  {activity.role && <p className="text-sm text-indigo-600 dark:text-indigo-200">{activity.role}</p>}
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <span className="text-xs text-violet-600 dark:text-violet-200 font-medium">{press.source}</span>
