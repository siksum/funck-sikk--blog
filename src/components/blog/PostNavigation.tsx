      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          {prevPost ? (
            ...
            >
              ...
              <h4
                className="font-semibold line-clamp-2 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors"
            ...
            <div className="p-4 rounded-xl border h-full opacity-50" style={{ background: 'var(--card-bg)', borderColor: 'var(--card-border)' }}>
              <div className="flex items-center gap-2 text-sm mb-2" style={{ color: 'var(--foreground-muted)' }}>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                </svg>
        ...
        <div>
          {nextPost ? (
            ...
            <div className="p-4 rounded-xl border h-full text-right opacity-50" style={{ background: 'var(--card-bg)', borderColor: 'var(--card-border)' }}>
              <div className="flex items-center justify-end gap-2 text-sm mb-2" style={{ color: 'var(--foreground-muted)' }}>
                다음 포스트
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
