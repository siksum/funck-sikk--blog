...
interface BlogDatabaseCardProps {
  id: string;
  title: string;
...
// Colors for database cards (violet theme)
const colors = {
...
export default function BlogDatabaseCard({
  title,
  description,
  slug,
  itemCount,
  variant = 'card',
}: BlogDatabaseCardProps) {
  const href = `/blog/db/${slug}`;
          ...
          <div className="relative p-4 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                <span className="px-1.5 py-0.5 text-xs rounded bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-400">
                  DB
                </span>
              </div>
