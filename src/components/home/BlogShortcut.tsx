...
export default function BlogShortcut({ postCount, categoryCount, tagCount }: BlogShortcutProps) {
  return (
    <Link href="/blog" className="block group">
      <div className="bg-gradient-to-r from-sky-100 to-teal-100 dark:from-sky-900/30 dark:to-teal-900/30 rounded-2xl p-8 md:p-12 relative overflow-hidden transition-transform hover:scale-[1.02] border border-sky-200 dark:border-sky-800/50">
        {/* Background decoration */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-sky-200/50 dark:bg-sky-800/20 rounded-full -translate-y-1/2 translate-x-1/2" />
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <span className="inline-flex items-center gap-2 text-sky-600 dark:text-sky-400 group-hover:text-sky-700 dark:group-hover:text-sky-300 transition-colors">
              모든 글 보기
