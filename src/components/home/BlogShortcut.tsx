...
export default function BlogShortcut({ postCount, categoryCount, tagCount }: BlogShortcutProps) {
  return (
    <Link href="/blog" className="block group">
      <div className="bg-gradient-to-r from-pink-50/70 to-rose-50/70 dark:from-pink-900/30 dark:to-rose-900/30 backdrop-blur-xl rounded-2xl py-12 px-8 md:py-20 md:px-12 relative overflow-hidden transition-all hover:scale-[1.02] hover:shadow-xl border border-white/50 dark:border-white/10 shadow-lg shadow-pink-200/30 dark:shadow-pink-900/20">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className="text-left">
            <h3 className="text-2xl md:text-3xl font-bold mb-3 flex items-center justify-start gap-3 text-gray-800 dark:text-white">
            ...
            <span className="inline-flex items-center gap-2 text-pink-500 dark:text-pink-400 group-hover:text-pink-600 dark:group-hover:text-pink-300 transition-colors">
              모든 글 보기
